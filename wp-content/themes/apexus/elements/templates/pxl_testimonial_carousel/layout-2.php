...
<?php if(isset($content_list) && !empty($content_list) && count($content_list) > 0): ?>
    <div class="pxl-swiper-slider pxl-testimonial-carousel layout-<?php echo esc_attr($settings['layout'])?>">
        ...
        <div class="row">
            ...
            ?>
            <div class="pxl-swiper-slider-thumbs col-7">
                <div class="pxl-swiper-slider-inner pxl-carousel-inner">
                    <div class="pxl-swiper-thumbs" data-settings="<?php echo esc_attr($data_thumb_settings) ?>">
                            ...
                            foreach ($content_list as $key => $value):
                                ...
                                <div class="pxl-swiper-slide thumb-item swiper-slide">
                                    ...
                                    <div class="thumbs-wrap">
                                        ...
                                        <a class="btn-audio media-play-button" <?php pxl_print_html($widget->get_render_attribute_string( $link_key )); ?>>
                                            <?php if ( ! empty( $value['link_button']['url'] ) ) ?>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                                                <path d="M23.8047 0C36.9518 0 47.6102 10.6576 47.6104 23.8047C47.6104 36.9519 36.9519 47.6104 23.8047 47.6104C10.6577 47.6102 0 36.9518 0 23.8047C0.000145459 10.6577 10.6578 0.000177418 23.8047 0ZM18.8057 32.3604L33.3613 23.9561L18.8057 15.5527V32.3604Z"/>
                                                </svg>
                                            <?php if ( ! empty( $value['link_button']['url'] ) ) ?>
                                        </a>
                                    </div>
            ...
            <div class="pxl-swiper-slider-wrap pxl-carousel-inner col-5">
                    ...
                    <div class="pxl-swiper-wrapper swiper-wrapper">
                        ...
                        <div class="pxl-swiper-slide swiper-slide">
                            <div class="item-inner relative">
                                <span class="item-title"><?php pxl_print_html($settings['title']); ?></span> 
