        ...
        <div class="pxl-swiper-slider-wrap pxl-carousel-inner overflow-hidden">
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                ...
                <div class="pxl-swiper-wrapper swiper-wrapper">
                    ...
                    $text_icon_1        = isset($value['text_icon_1']) ? $value['text_icon_1'] : '';
                    $text_icon_2        = isset($value['text_icon_2']) ? $value['text_icon_2'] : '';
                                ...
                                <div class="logo-icon">
                                    ...
                                    <div class="box-icon">
                                        ...
                                        <span class="item-text-icon">
                                            <span class="text-1"><?php pxl_print_html($text_icon_1); ?></span>
                                            <span class="text-2"><?php pxl_print_html($text_icon_2); ?></span>
                                        </span>
                                    </div>
                                </div>
                                <h4 class="item-title pxl-split-text split-in-fade"><?php pxl_print_html($title); ?></h4>
