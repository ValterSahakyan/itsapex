...
<?php if(isset($boxs) && !empty($boxs) && count($boxs) > 0): ?>
    <div class="pxl-swiper-slider pxl-fancy-box-carousel layout-<?php echo esc_attr($settings['layout'])?>">
        ...
        <?php endif; ?>
        <div class="pxl-swiper-slider-wrap pxl-carousel-inner pxl-animated-waypoint overflow-hidden">
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper swiper-wrapper">
                    ...
                    <div class="pxl-swiper-slide swiper-slide">
                        <div class="item-inner" style="background-image: url('<?php echo esc_url($thumbnail); ?>');">
                            <div class="box-icon">
