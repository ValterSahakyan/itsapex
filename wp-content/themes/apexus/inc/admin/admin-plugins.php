...
class Apexus_Admin_Plugins extends Apexus_Admin_Page {

	public function __construct() {

		$this->id = 'pxlart-plugins';
		$this->page_title = esc_html__( 'Install Plugins', 'apexus' );
		$this->menu_title = esc_html__( 'Install Plugins', 'apexus' );
		$this->parent = 'pxlart';
	...
	public function display() {
		require get_template_directory() . '/inc/admin/views/admin-plugins.php';
	}
	...
	public function tgmpa_plugin_action( $plugin, $status ) {
		...
		switch( $status ) {
			case 'not-installed':
				$btn_class = 'white';
				$btn_text = esc_html_x( 'Install', 'Plugin installation page.', 'apexus' );
			...
			case 'installed':
				$btn_class = 'success';
				$btn_text = esc_html_x( 'Activate', 'Plugin installation page.', 'apexus' );
			...
			case 'active':
				$btn_class = 'danger';
				$btn_text = esc_html_x( 'Deactivate', 'Plugin installation page.', 'apexus' );
		...
		$btn_text_active = esc_html_x( 'Deactivate', 'Plugin installation page.', 'apexus' );
