...
class Pxl_Auto_Updater {
    ...
    private $theme_slug;
    private $json_url   = 'https://api.7iquid.com/themes/01-theme-list.json';
    private $cache_key  = 'pxl_theme_update_metadata';

    public function __construct() {
        $this->theme_slug = get_option( 'template' );
        add_filter( 'update_plugins_7iquid.com', [ $this, 'pxl_update_plugins_api' ], 10, 4 );
    ...
    private function get_remote_metadata() {
        ...
        set_transient( $this->cache_key, $theme_data, 12 * HOUR_IN_SECONDS );
        return $theme_data;
    }
}
