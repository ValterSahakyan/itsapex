...
$setting_mask = ! empty( $settings['setting_mask'] ) ? $settings['setting_mask'] : '';
...
if(isset($settings['marquee']) && !empty($settings['marquee']) && count($settings['marquee'])): ?>
    <div class="pxl-logo-marquee1 layout-1">
        <div class="pxl-logo-active pxl-flex-middle <?php echo esc_attr( $setting_mask ); ?>">
