<?php
/**
* The Apexus_Admin initiate the theme admin
*/
...
class Apexus_Admin extends Apexus_Base{
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'pxlart-admin', get_template_directory_uri() . '/inc/admin/assets/css/admin.css' );
    ...
    public function fix_parent_menu() {
		...
		$submenu['pxlart'][0][0] = apexus()->get_name().' '.esc_html__( 'Dashboard', 'apexus' );
