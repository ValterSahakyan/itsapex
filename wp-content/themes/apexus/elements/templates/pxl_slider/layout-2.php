...
$opts = [
    ...
    'loop'                 => $infinite != '' ? (bool)$infinite : true,
...
<?php if(isset($content_list) && !empty($content_list) && count($content_list) > 0): ?>
    <div class="pxl-swiper-slider pxl-slider layout-<?php echo esc_attr($settings['layout'])?>">
        ...
        <div class="pxl-swiper-slider-wrap pxl-carousel-inner overflow-hidden">
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper swiper-wrapper">
                    ...
                    ?>
                    <div class="pxl-swiper-slide swiper-slide swiper-slide-5215">
                        <div class="item-inner relative elementor-repeater-item-<?php echo esc_attr($value['_id']); ?>">
                            ...
                            <div class="item-content">
                                ...
                                <div class="button-more">
                                    <a class="pxl-btn btn-seventh" <?php pxl_print_html($widget->get_render_attribute_string( $link_key )); ?>>
                                        <?php if ( ! empty( $value['link_content']['url'] ) ) ?>
                                        <span class="pxl-button-text"><?php pxl_print_html($button_text); ?></span>
                                        <span class="pxl-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                <path d="M4.66797 11.334L10.668 5.33398" stroke="currentColor" stroke-width="1.33333" stroke-linecap="square" stroke-linejoin="round"/>
                                                <path d="M4.66797 4.66602H11.3346V11.3327" stroke="currentColor" stroke-width="1.33333" stroke-linecap="square" stroke-linejoin="round"/>
                                            </svg>
                                        </span>
                                        <?php if ( ! empty( $value['link_content']['url'] ) ) ?>
                                    </a>
