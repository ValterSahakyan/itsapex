...
$img_size = !empty( $img_size ) ? $img_size : '479x286';
?>
                    ...
                    <div class="pxl-swiper-slide swiper-slide">
                        <div class="item-inner">
                            <?php if(!empty($thumbnail)): ?>
                                <div class="item-image scale-hover-x-left">
                                    <?php pxl_print_html($thumbnail); ?>
                                </div>
                            <?php endif; ?>
                            <?php if(! empty($box['selected_icon_2'])): ?>
                                <span class="item-icon">
                                    <?php \Elementor\Icons_Manager::render_icon( $box['selected_icon_2'], [ 'aria-hidden' => 'true'] );?>
                                </span>
                            <?php endif; ?>
                                    ...
                                    <div class="item-button">
                                        <?php if ( $link_attributes ) echo '<a class="btn-more" '. implode( ' ', [ $link_attributes ] ).'>'; ?>
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                ...
                                                <path d="M14 17L19 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="square"/>
                                                <path d="M14 7L19 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="square"/>
                                            </svg>
